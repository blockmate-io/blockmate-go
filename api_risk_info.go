...
type ApiGetMultipleAddressRiskScoreRequest struct {
	ctx context.Context
	ApiService *RiskInfoApiService
	chain *string
	requestBody *[]string
...
// Blockchain identifier
func (r ApiGetMultipleAddressRiskScoreRequest) Chain(chain string) ApiGetMultipleAddressRiskScoreRequest {
	r.chain = &chain
	return r
}

// Addresses for which risk should be returned (maximum of 5000 in one request)
func (r ApiGetMultipleAddressRiskScoreRequest) RequestBody(requestBody []string) ApiGetMultipleAddressRiskScoreRequest {
	r.requestBody = &requestBody
	return r
}

func (r ApiGetMultipleAddressRiskScoreRequest) Execute() (map[string]int32, *http.Response, error) {
	return r.ApiService.GetMultipleAddressRiskScoreExecute(r)
}

/*
GetMultipleAddressRiskScore Get multiple risk scores for addresses

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetMultipleAddressRiskScoreRequest
*/
func (a *RiskInfoApiService) GetMultipleAddressRiskScore(ctx context.Context) ApiGetMultipleAddressRiskScoreRequest {
	return ApiGetMultipleAddressRiskScoreRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *RiskInfoApiService) GetMultipleAddressRiskScoreExecute(r ApiGetMultipleAddressRiskScoreRequest) (map[string]int32, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RiskInfoApiService.GetMultipleAddressRiskScore")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
